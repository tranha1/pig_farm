"""
Django settings for pig_farm project.
...
WSGI_APPLICATION = "pig_farm.wsgi.application"
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='pig_farm_db'),
